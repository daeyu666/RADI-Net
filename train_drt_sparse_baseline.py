"""
DRT ResBlock baseline + sparse self-attention block 训练脚本。

该模型基于 PlainDRTBaseline，只把融合主干中的部分 ResBlock 替换为
ASSANet 启发的 SparseSelfAttentionBlock，默认替换第 2、4、6 个融合 ResBlock。

示例：
python train_drt_sparse_baseline.py --dataset PaviaU --msi_mode srf --srf_band_set wv2_visible6 --epochs 300 --batch_size 4
"""
...
def main():
    ...
    write_log(log_path, "Model variant: DRTSparseBaseline")
    write_log(log_path, "Sparse positions: (1, 3, 5)")

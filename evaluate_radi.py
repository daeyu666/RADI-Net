...
示例：
python evaluate_radi.py --dataset PaviaU --msi_mode srf --srf_band_set wv2_visible6 --resume checkpoints/radi_net/radi_net_v1_PaviaU_wv2_visible6_x4/best.pth
"""
...
def evaluate_and_save(model, loader, device, cfg, save_prediction: bool = True) -> Dict[str, float]:
    ...
    for idx, batch in enumerate(loader):
        ...
        if save_prediction:
            save_path = os.path.join(save_dir, f"radi_net_v1_sample{idx}.mat")
            save_mat(
                save_path,
                {
